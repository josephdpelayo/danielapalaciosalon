...
export async function POST(req: NextRequest) {
  ...
  const { name, description, price, duration_minutes, active_minutes, deposit_amount, category } = body;
...
export async function PATCH(req: NextRequest) {
  ...
  if (fields.sort_order       !== undefined) updates.sort_order       = parseInt(fields.sort_order);
